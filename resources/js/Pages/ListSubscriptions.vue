<template>
    <app-layout title="Dashboard">
               ...
               <!-- inicio -->
                <table class="table-auto border w-full">
                    ...
                    <tr>
                        ...
                        <th class="border p-3">Nacionalidade</th>
        ...
        <div class="bg-white py-5" style="text-align: center !important;">
